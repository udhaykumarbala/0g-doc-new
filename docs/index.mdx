...
description: "Developer documentation for 0G (Zero Gravity), the trust layer for AI: private compute, encrypted storage, data availability, and an AI-native L1."
hide_title: true
...
<div className="landing-section developer-section">
  <div className="resource-grid">
    ...
    <Link to="/node-sale/ai-alignment-node-user-guide" className="resource-card">
      ...
      <div className="card-content">
        <div className="card-header">
          <h3>AI Alignment Node</h3>
        </div>
        <p>Learn more about the AI Alignment Node operation</p>
        <div className="card-footer">
