...
sidebar_position: 3
description: "ERC-7857 technical specification for encrypted NFT metadata — the standard powering Agentic IDs (formerly INFTs). Covers transfer architecture, TEE and ZKP oracle implementations, and security guidelines."
keywords: [erc-7857, erc7857, agentic id standard, inft standard, encrypted nft, tee oracle, zkp oracle, ai agent transfer]
---
...
### Document Purpose
This page provides the technical specification, implementation details, and security considerations for ERC-7857. For high-level concepts, see the **[INFT Overview](./overview)**.
